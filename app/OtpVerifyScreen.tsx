...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#fff', padding: 15, borderRadius: 10, marginBottom: 20, textAlign: 'center', fontSize: 18, borderWidth: 1, borderColor: '#ccc' },
  mainButton: { backgroundColor: '#1A442E', padding: 15, borderRadius: 10, alignItems: 'center' },
